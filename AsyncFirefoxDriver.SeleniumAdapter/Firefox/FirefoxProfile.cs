...
namespace OpenQA.Selenium.Firefox
{
    ...
    public class FirefoxProfile
    {
        ...
        public FirefoxProfile(string profileDirectory, bool deleteSourceOnClean)
        {
            ...
            this.profilePort = Zu.AsyncFirefoxDriver.SeleniumAdapter.FirefoxDriver.DefaultPort;
            this.enableNativeEvents = Zu.AsyncFirefoxDriver.SeleniumAdapter.FirefoxDriver.DefaultEnableNativeEvents;
            this.acceptUntrustedCerts = Zu.AsyncFirefoxDriver.SeleniumAdapter.FirefoxDriver.AcceptUntrustedCertificates;
            this.assumeUntrustedIssuer = Zu.AsyncFirefoxDriver.SeleniumAdapter.FirefoxDriver.AssumeUntrustedCertificateIssuer;
