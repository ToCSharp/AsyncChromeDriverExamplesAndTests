...
namespace OpenQA.Selenium
{
    ...
    public class IgnoreBrowserAttribute : NUnitAttribute, IApplyToTest
    {
        ...
        public void ApplyToTest(Test test)
        {
            if (test.RunState != RunState.NotRunnable)
            {
                ...
                foreach (Attribute attr in ignoreAttributes)
                {
                    ...
                    {
                        string ignoreReason = "Ignoring browser " + EnvironmentManager.CurrentTestingBrowser/*Instance.Browser*/.ToString() + ".";
        ...
        {
            return browserToIgnore.Equals(EnvironmentManager.CurrentTestingBrowser/*Instance.Browser*/) || browserToIgnore.Equals(Browser.All);// || IsRemoteInstanceOfBrowser(browserToIgnore);
        }
